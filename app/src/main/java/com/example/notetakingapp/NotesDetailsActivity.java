...
public class NotesDetailsActivity extends AppCompatActivity {
    ...
    void  saveNote(){
        ...
        if(noteTitle==null || noteTitle.isEmpty()){
            Utility.showToast(NotesDetailsActivity.this, "Title is required!");
            return;
        }
        ...
        documentReference.set(note).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    //note is not added
                    Utility.showToast(NotesDetailsActivity.this,"Failed while adding notes");
                    finish();
                }
            }
        });
        ...
        documentReference.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    //note is not added
                    Utility.showToast(NotesDetailsActivity.this,"Failed while deleting notes");
                    finish();
                }
            }
        });
